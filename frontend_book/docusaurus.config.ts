...
const config: Config = {
  title: 'AI-driven Textbook on Physical AI & Humanoid Robotics',
  tagline: 'Comprehensive Educational Resource on ROS 2, AI Integration, and Humanoid Robotics',
  ...
  i18n: {
    defaultLocale: 'en',
    locales: ['en', 'ur'], // English and Urdu as specified in constitution
  },
